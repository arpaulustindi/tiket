                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const Spacer(),
                              Text("MDO", style: Styles.textStyle),
                            ],
                          ),
                        ),
                        const Gap(3),
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text("Tahuna", style: Styles.headLineStyle4),
                              Text("8J 30M", style: Styles.headLineStyle4),
                              Text("Manado", style: Styles.headLineStyle4),
                            ],
                          ),
                        )
                      ],
                                ...
                                Column(
                                  children: [
                                    Text("23",
                                        style: Styles.headLineStyle3
                                            .copyWith(color: Colors.black)),
                                    Text("Nomor", style: Styles.headLineStyle4)
                                  ],
                                )
                              ],
                            ),
                            ...
                            children: [
                              Text("71031XXX00XX",
                                  style: Styles.headLineStyle3
                                      .copyWith(color: Colors.black)),
                              Gap(AppLayout.getHeight(5)),
                              Text("KTP", style: Styles.headLineStyle3)
                            ],
                          )
                        ],
                      ),
                            ...
                            children: [
                              Text("BOK001",
                                  style: Styles.headLineStyle3
                                      .copyWith(color: Colors.black)),
                              Gap(AppLayout.getHeight(5)),
                              Text("Kode Booking", style: Styles.headLineStyle3)
                            ],
                          )
                        ],
                      ),
                            ...
                            children: [
                              Text("Rp.415.000,-",
                                  style: Styles.headLineStyle3
                                      .copyWith(color: Colors.black)),
                              Gap(AppLayout.getHeight(5)),
                              Text("Harga", style: Styles.headLineStyle3)
                            ],
                          )
                        ],
                      ),
